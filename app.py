import gradio as gr
from chunk import load_documents, chunk_document
...
def run_ingestion():
    ...
    if all_chunks:
        ...
        print(
            ...
            "    The Bot will start, but won't be able to answer questions yet.\n"
        )
    ...
    gr.HTML("""
        <div style="text-align:center; padding:1.25rem 0 0.5rem;">
            ...
            <p style="color:#6b7280; font-size:1rem; margin:0.4rem 0 0;">
                Ask anything about off-campus housing at the University of Chicago!
            </p>
        </div>
    """)
        ...
        with gr.Column(scale=3):
            gr.ChatInterface(
                ...
                chatbot=gr.Chatbot(placeholder=(
                    ...
                    "</div>")),
                textbox=gr.Textbox(
                    placeholder='e.g. "What are the best off-campus apartment options?"',
                    container=False,
                    scale=7,
                ),
                examples=[
                    "What is the most popular off-campus apartment at UChicago?",
                    "Does everyone live off-campus at UChicago?",
                    "What are some of the attractions near Hyde Park?",
                    "How do students get groceries at Hyde Park?",
                    "What are the main considerations when looking for housing?",
                    "What is the average price of a studio apartment in Hyde Park?",
                    "What is the cheapest option for off-campus housing?",
                    "Is it safe to live off-campus in Hyde Park?",
                    "What are the main tradeoffs of living off-campus vs. on-campus?",
                ],
            ...
            gr.HTML("""
                <div style="background:#f5f3ff; border:1px solid #ddd6fe;
                    ...
                    <ul style="font-size:0.85rem; color:#5b21b6; list-style:none;
                        ...
                        <li>Chicago Maroon</li>
                        <li>Maroon Housing</li>
                        <li>Prked.com</li>
                        <li>Reddit</li>
                        <li>UChicago GRAD</li>
                        <li>Uhomes.com</li>
                    ...
                    <p style="font-size:0.75rem; color:#7c3aed; margin:0; line-height:1.5;">
                        Answers are grounded in the loaded sources only. If an answer
                        isn't in the sources, the bot will say so.
                    </p>
                </div>
            """)
